...
The biggest thing I learned is how much of a recommender's behavior comes down to arbitrary-seeming weight choices — genre being worth 2 points and mood being worth 1 point felt like a reasonable starting guess, but the weight-shift experiment showed those exact numbers determine whether a completely irrelevant song can nearly tie a genuinely well-matched one. Something unexpected was seeing the adversarial profile expose this so clearly: a system that looks like it's "working" on easy inputs can fall apart the moment you give it a contradictory but realistic request, which made me think differently about how much I should trust a recommendation app's confidence in what it suggests. It also made me realize that "smart-feeling" recommendations don't require any actual learning — a handful of if-statements and a subtraction can produce a ranked list that feels personalized, which is a useful thing to keep in mind whenever an app seems to "just get" my taste.
